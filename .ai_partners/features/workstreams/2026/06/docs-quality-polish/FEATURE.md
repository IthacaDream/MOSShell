---
title: Docs Quality Polish — 已有文档修正 + 缺失文档补齐，docs 体系本次闭环
status: completed
priority: P1
created: 2026-06-02
updated: 2026-06-03
...
milestone:
description: >-
  逐篇审查已有 6 篇 docs，修正过时引用、统一标题风格；补齐 docs-howtos-governance 路线图中标记为 P0 待写的关键文档。2026-06-03 P0 文档 3/3 撰写完成，docs 从 6 篇到 10 篇。
---
...
### Phase 3: P0 新文档撰写 ✅ (2026-06-03)

- [x] `what-is-moss.md` (#01) — 10 节：直觉、边界、心智模型、设计原则、能/不能、起源、成熟度、入口
- [x] `matrix-system.md` (#04) — 6 节：why、when、Cell/provide-proxy/Session/Fractal、Manifests 配对、协议可替换
- [x] `development-workflow.md` (#07) — 9 步轨迹：调研→安装→moss-cli/repl→Hello World MCP→运行时理解→第一个 App→物理世界→features→Beta

以下两篇不在此 feature 完成：
- [ ] `channel-and-command.md` (#03) — `channel-system.md` 已覆盖构建/集成/发现全链路。核心 API 知识后续开独立 feature 或由 channel-system 演进
- [ ] `ghost-development.md` (#05) — 由 `first-ghost-prototype` feature (P0, awaiting_human_validation) 承接

### Phase 4: P1 (后续)

- [ ] CTML/Logos 语言参考 (#10) — `ctml.md` 已覆盖设计哲学和测试地图
- [ ] 迭代管理机制 (#09) — features + howtos + docs 协同演进

### 2026-06-03 完成声明

P0 文档 3/3 撰写完成。docs 从 6 篇到 10 篇，howtos 从 11 篇清淤到 8 篇。
`docs-howtos-governance` 路线图的 P0 目标达成。P1 项留给后续会话决定优先级。
